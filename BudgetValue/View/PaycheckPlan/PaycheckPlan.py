...
class PaycheckPlan(tk.Frame):
    ...
    def __init__(self, parent, vModel):
        ...
        vButton_Save = ttk.Button(self.vButtonBar, text="Save", command=lambda self=self: self.vModel.PaycheckPlan.Save())
        vButton_Save.pack(side=tk.LEFT, anchor='w')
        vButton_Load = ttk.Button(self.vButtonBar, text="Load", command=lambda self=self: self.Load())
